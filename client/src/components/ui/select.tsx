  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[placeholder]:text-muted-foreground [&_svg:not([class*='text-'])]:text-muted-foreground items-center justify-between gap-2 whitespace-nowrap data-[size=default]:h-9.5 data-[size=sm]:h-8",
        // Clean up select-specific classes
